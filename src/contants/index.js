...
export const WHATSAPP_MESSAGE =
	process.env.NEXT_PUBLIC_WHATSAPP_MESSAGE || 'Olá! Gostaria de agendar uma consulta com o Dr. Leonardo Barreto. Link disponível em www.drleonardobarreto.med.br';
