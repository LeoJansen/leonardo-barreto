...
function Specialization() {
    ...
    return (
        <section>
            ...
            <div className='flex flex-col w-full items-end justify-center  p-5  py-8 xl:p-8  xl:pb-10 z-20 '>
                <div className='shadow-[1px_1px_6px_2px_rgba(10,51,40,0.1924)] border-2 border-[#cadbdbb7] p-5 px-10 rounded-2xl bg-[#f5f5f5]'>
                {/* Título da seção */}
