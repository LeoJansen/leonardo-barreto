            ...
            <div className=" w-full h-full xl:rounded-2xl">
                <div className="content">
                    <div className="relative cocktail-img  max-w-full h-80  xl:h-[600px] flex w-full">
                        ...
                        <div className="hidden xl:flex w-2/5 h-full bg-[#176565] rounded-l-xl text-[#d4d4d4] align z-20 items-center justify-center text-justify leading-relaxed py-10 px-10   text-md">
