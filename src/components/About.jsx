...
function About() {
    return (
        <section className="p-6 px-10 bg-[#DFDFDF]">
            <div className='w-full h-full grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-center justify-items-center'>
                ...
                {/* Parágrafos de texto */}
                <div className="col-start-1 row-start-3 md:row-start-2 md:col-start-2 flex mt-6 text-sm text-[#5e5e5e] leading-relaxed text-justify space-y-4 px-2">
                    <p>
